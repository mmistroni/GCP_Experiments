...
def map_to_bq_dict(input_dict, label):
    return dict(AS_OF_DATE=date.today(), TICKER=input_dict['symbol'], LABEL=label, PRICE=input_dict['price'],
                ...
                DIVIDENDRATIO=input_dict.get('dividendRatio', 0.0),
...
def run(argv=None, save_main_session=True):
    ...
    bq_sink = beam.io.WriteToBigQuery(
            ...
            schema='AS_OF_DATE:DATE,TICKER:STRING,LABEL:STRING,PRICE:FLOAT,YEARHIGH:FLOAT,YEARLOW:FLOAT,PRICEAVG50:FLOAT,PRICEAVG200:FLOAT,BOOKVALUEPERSHARE:FLOAT," + \
                    "TANGIBLEBOOKVALUEPERSHARE:FLOAT,CASHFLOWPERSHARE:FLOAT,MARKETCAP:FLOAT," + \
                    "ASSET_VALUE:FLOAT,EXCESS_MARKETCAP:FLOAT,DIVIDENDRATIO:FLOAT,PERATIO:FLOAT',
